...
const team = [
  {
    ...
    color: "#6366f1",
    highlights: [
      "IS-TEWS Creator — AUC 0.9957",
      "TCS NQT Digital Cleared",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="font-mono text-[10px] tracking-wide mb-2" style={{ color: member.color }}>
          {member.role}
        </p>
        ...
        <div className="space-y-1.5 mb-4">
          {member.highlights.map((h) => (
            <div key={h} className="flex items-start gap-2">
              <span className="text-[10px] mt-1" style={{ color: member.color }}>
                ▸
              </span>
        ...
        <div className="flex gap-3">
          <a
            ...
            className="text-xs text-muted-foreground hover:text-primary transition-colors nav-link-magnet"
          >
            GitHub ↗
          </a>
          <a
