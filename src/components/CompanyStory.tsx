...
export default function CompanyStory() {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Clean code, working systems, minimal scope. We build what's needed, not what's cool.",
    },
    {
      icon: "📍",
      title: "Local Roots",
    ...
    },
    {
      ...
      description:
        "We measure success by your success — repeat work and referrals matter more than one-time deals.",
    },
  ];
  ...
  const timeline = [
    {
      ...
      milestone: "Founded",
      description:
        "Four ECE engineers from Tirunelveli started building for real businesses instead of corporates.",
    },
    {
      year: "2024",
      milestone: "First 10 Projects",
      description:
        "Delivered websites, IoT systems, and marketing solutions. Established strong local reputation.",
    },
    {
      year: "2025",
    ...
    <>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <p>
              Four ECE (Electronics and Communication Engineering) students from Tirunelveli had a
              choice: join a corporation or build something real.
            </p>

            <p>
              We spent years building projects for others—tech that worked, customers that were
              satisfied, but no ownership. We realized we wanted to build for businesses we believed
              in: local clinics, contractors with 20+ years of experience, gyms, restaurants. The
              kind of businesses that don't need venture funding or hype, they need results.
            </p>

            <p>
              So we started <strong>Kural Innovations</strong> — a "build lab" where ideas are
              engineered into real solutions. The name comes from the ancient Tamil text
              Thirukkural: short wisdom that creates powerful impact. That's our philosophy.
            </p>

            <p>
              Today, we're a team of ECE engineers, some with TCS NQT Digital certifications, some
              RHCSA-certified in infrastructure. We build websites that convert, marketing
              strategies that work in local markets, IoT systems with real dashboards, and AI models
              that predict measurable outcomes. We've deployed energy monitors in factories, gas
              detection systems in restaurants, and booking interfaces that process hundreds of
              transactions daily.
            </p>

            <p className="text-primary font-semibold">
              Every project solves a real problem for a real business. No mockups. No promises.
              Working systems.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Four ECE engineers from Tirunelveli — certified, experienced, and committed to
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl border border-border bg-background">
              ...
              <p className="text-muted-foreground mt-2">
                Firebase, REST APIs, database design, and infrastructure automation.
                RHCSA-certified. Built systems processing 1000s of daily transactions.
              </p>
            </div>
            <div className="p-8 rounded-2xl border border-border bg-background">
              <h3 className="font-heading text-xl font-bold">Frontend & UI/UX</h3>
              <p className="text-muted-foreground mt-2">
                React, TypeScript, Tailwind CSS, animations. Responsive design specialist.
                Previously designed interfaces for 500k+ users.
              </p>
            </div>
            <div className="p-8 rounded-2xl border border-border bg-background">
              <h3 className="font-heading text-xl font-bold">IoT & Embedded Systems</h3>
              <p className="text-muted-foreground mt-2">
                ESP8266, ESP32, sensor integration, real-time dashboards. Deployed energy monitors,
                gas detectors, motion sensors in live systems.
              </p>
            </div>
            <div className="p-8 rounded-2xl border border-border bg-background">
              <h3 className="font-heading text-xl font-bold">AI/ML & Data Science</h3>
              <p className="text-muted-foreground mt-2">
                LightGBM, TensorFlow, predictive models, data analysis. Built IS-TEWS tsunami
                prediction model with AUC 0.9957.
              </p>
            </div>
          </div>
        </div>
