        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              combined with the right technology, creates meaningful real-world impact.
            </p>
          </div>

          <div
            className={`space-y-4 transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
          >
            {[
              {
                icon: "🔧",
